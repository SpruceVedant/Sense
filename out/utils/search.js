...
async function search(keyword) {
    ...
    const promise = new Promise(async (resolve, reject) => {
        ...
        vscode.window.setStatusBarMessage(`SuiteSense: Finished loading ${results.length} results`);
    });
    vscode.window.setStatusBarMessage(`SuiteSense: Start loading snippet results...`, promise);
    return promise;
}
